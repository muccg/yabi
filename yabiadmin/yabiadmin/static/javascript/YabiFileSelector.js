...
YabiFileSelector.prototype.hydrateProcess = function(jsonObj) {
  ...
  // new style 20090921 has the path as the key for the top level, then files
  // as an array and directories as an array
 ...
 */
YabiFileSelectorPreview.prototype.createControlButton = function(className,
                                                            onClick, title) {
...
YabiFileSelectorPreview.prototype.createControls = function() {
  ...
  // Add buttons.
  controls.appendChild(this.createControlButton('fileSelectorPreviewClose',
      function(e) {
        self.closeCallback();
      }, 'close preview'));

  controls.appendChild(this.createControlButton('fileSelectorPreviewDownload',
      function(e) {
  ...
  controls.appendChild(this.createControlButton('fileSelectorPreviewPrevious',
                                                previousCallback, title));
