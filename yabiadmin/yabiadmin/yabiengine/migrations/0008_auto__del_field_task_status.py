...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('yabiengine_task', 'status')


    def backwards(self, orm):
        
        # Adding field 'Task.status'
        db.add_column('yabiengine_task', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)
