...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.tool'
        db.add_column(six.u('yabiengine_job'), 'tool',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.Tool'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.tool'
        db.delete_column(six.u('yabiengine_job'), 'tool_id')
    ...
    models = {
        ...
        six.u('yabiengine.job'): {
            ...
            'tool': ('django.db.models.fields.related.ForeignKey', [], {'to': six.u("orm['yabi.Tool']"), 'null': 'True'}),
            'walltime': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
