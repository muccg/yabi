...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.status_pending'
        db.add_column('yabiengine_task', 'status_pending', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_ready'
        db.add_column('yabiengine_task', 'status_ready', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_requested'
        db.add_column('yabiengine_task', 'status_requested', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_stagein'
        db.add_column('yabiengine_task', 'status_stagein', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_mkdir'
        db.add_column('yabiengine_task', 'status_mkdir', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec'
        db.add_column('yabiengine_task', 'status_exec', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_unsubmitted'
        db.add_column('yabiengine_task', 'status_exec_unsubmitted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_pending'
        db.add_column('yabiengine_task', 'status_exec_pending', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_active'
        db.add_column('yabiengine_task', 'status_exec_active', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_running'
        db.add_column('yabiengine_task', 'status_exec_running', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_cleanup'
        db.add_column('yabiengine_task', 'status_exec_cleanup', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_done'
        db.add_column('yabiengine_task', 'status_exec_done', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_exec_error'
        db.add_column('yabiengine_task', 'status_exec_error', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_stageout'
        db.add_column('yabiengine_task', 'status_stageout', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_cleaning'
        db.add_column('yabiengine_task', 'status_cleaning', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.status_complete'
        db.add_column('yabiengine_task', 'status_complete', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Task.status_pending'
        db.delete_column('yabiengine_task', 'status_pending')

        # Deleting field 'Task.status_ready'
        db.delete_column('yabiengine_task', 'status_ready')

        # Deleting field 'Task.status_requested'
        db.delete_column('yabiengine_task', 'status_requested')

        # Deleting field 'Task.status_stagein'
        db.delete_column('yabiengine_task', 'status_stagein')

        # Deleting field 'Task.status_mkdir'
        db.delete_column('yabiengine_task', 'status_mkdir')

        # Deleting field 'Task.status_exec'
        db.delete_column('yabiengine_task', 'status_exec')

        # Deleting field 'Task.status_exec_unsubmitted'
        db.delete_column('yabiengine_task', 'status_exec_unsubmitted')

        # Deleting field 'Task.status_exec_pending'
        db.delete_column('yabiengine_task', 'status_exec_pending')

        # Deleting field 'Task.status_exec_active'
        db.delete_column('yabiengine_task', 'status_exec_active')

        # Deleting field 'Task.status_exec_running'
        db.delete_column('yabiengine_task', 'status_exec_running')

        # Deleting field 'Task.status_exec_cleanup'
        db.delete_column('yabiengine_task', 'status_exec_cleanup')

        # Deleting field 'Task.status_exec_done'
        db.delete_column('yabiengine_task', 'status_exec_done')

        # Deleting field 'Task.status_exec_error'
        db.delete_column('yabiengine_task', 'status_exec_error')

        # Deleting field 'Task.status_stageout'
        db.delete_column('yabiengine_task', 'status_stageout')

        # Deleting field 'Task.status_cleaning'
        db.delete_column('yabiengine_task', 'status_cleaning')

        # Deleting field 'Task.status_complete'
        db.delete_column('yabiengine_task', 'status_complete')
