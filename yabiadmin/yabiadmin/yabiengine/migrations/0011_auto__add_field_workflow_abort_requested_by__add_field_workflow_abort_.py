...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.abort_requested_by'
        db.add_column(six.u('yabiengine_workflow'), 'abort_requested_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='aborted_workflows', null=True, to=orm['yabi.User']),
                      keep_default=False)

        # Adding field 'Workflow.abort_requested_on'
        db.add_column(six.u('yabiengine_workflow'), 'abort_requested_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.abort_requested_by'
        db.delete_column(six.u('yabiengine_workflow'), 'abort_requested_by_id')

        # Deleting field 'Workflow.abort_requested_on'
        db.delete_column(six.u('yabiengine_workflow'), 'abort_requested_on')
    ...
    models = {
        ...
        six.u('yabiengine.workflow'): {
            ...
            'abort_requested_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aborted_workflows'", 'null': 'True', 'to': six.u("orm['yabi.User']")}),
