...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'yabiengine_workflow', 'abort_requested_by',
        ...
        db.add_column(u'yabiengine_workflow', 'abort_requested_on',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'yabiengine_workflow', 'abort_requested_by_id')

        # Deleting field 'Workflow.abort_requested_on'
        db.delete_column(u'yabiengine_workflow', 'abort_requested_on')
