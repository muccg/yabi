...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credential.security_state'
        db.add_column(six.u('yabi_credential'), 'security_state',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credential.security_state'
        db.delete_column(six.u('yabi_credential'), 'security_state')
