...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'yabi_user', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'User.created_by'
        db.alter_column(u'yabi_user', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'BackendCredential.created_by'
        db.alter_column(u'yabi_backendcredential', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'BackendCredential.last_modified_by'
        db.alter_column(u'yabi_backendcredential', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolGroup.last_modified_by'
        db.alter_column(u'yabi_toolgroup', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolGroup.created_by'
        db.alter_column(u'yabi_toolgroup', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'FileType.last_modified_by'
        db.alter_column(u'yabi_filetype', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'FileType.created_by'
        db.alter_column(u'yabi_filetype', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Tool.last_modified_by'
        db.alter_column(u'yabi_tool', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Tool.created_by'
        db.alter_column(u'yabi_tool', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Backend.created_by'
        db.alter_column(u'yabi_backend', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Backend.last_modified_by'
        db.alter_column(u'yabi_backend', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'HostKey.last_modified_by'
        db.alter_column(u'yabi_hostkey', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'HostKey.created_by'
        db.alter_column(u'yabi_hostkey', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolParameter.last_modified_by'
        db.alter_column(u'yabi_toolparameter', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolParameter.created_by'
        db.alter_column(u'yabi_toolparameter', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolGrouping.last_modified_by'
        db.alter_column(u'yabi_toolgrouping', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolGrouping.created_by'
        db.alter_column(u'yabi_toolgrouping', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ParameterSwitchUse.last_modified_by'
        db.alter_column(u'yabi_parameterswitchuse', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ParameterSwitchUse.created_by'
        db.alter_column(u'yabi_parameterswitchuse', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Credential.created_by'
        db.alter_column(u'yabi_credential', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Credential.last_modified_by'
        db.alter_column(u'yabi_credential', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolOutputExtension.last_modified_by'
        db.alter_column(u'yabi_tooloutputextension', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolOutputExtension.created_by'
        db.alter_column(u'yabi_tooloutputextension', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'FileExtension.last_modified_by'
        db.alter_column(u'yabi_fileextension', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'FileExtension.created_by'
        db.alter_column(u'yabi_fileextension', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolSet.last_modified_by'
        db.alter_column(u'yabi_toolset', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ToolSet.created_by'
        db.alter_column(u'yabi_toolset', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'User.last_modified_by'
        db.alter_column(u'yabi_user', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'User.created_by'
        db.alter_column(u'yabi_user', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'BackendCredential.created_by'
        db.alter_column(u'yabi_backendcredential', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'BackendCredential.last_modified_by'
        db.alter_column(u'yabi_backendcredential', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolGroup.last_modified_by'
        db.alter_column(u'yabi_toolgroup', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolGroup.created_by'
        db.alter_column(u'yabi_toolgroup', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'FileType.last_modified_by'
        db.alter_column(u'yabi_filetype', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'FileType.created_by'
        db.alter_column(u'yabi_filetype', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Tool.last_modified_by'
        db.alter_column(u'yabi_tool', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Tool.created_by'
        db.alter_column(u'yabi_tool', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Backend.created_by'
        db.alter_column(u'yabi_backend', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Backend.last_modified_by'
        db.alter_column(u'yabi_backend', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'HostKey.last_modified_by'
        db.alter_column(u'yabi_hostkey', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'HostKey.created_by'
        db.alter_column(u'yabi_hostkey', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolParameter.last_modified_by'
        db.alter_column(u'yabi_toolparameter', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolParameter.created_by'
        db.alter_column(u'yabi_toolparameter', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolGrouping.last_modified_by'
        db.alter_column(u'yabi_toolgrouping', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolGrouping.created_by'
        db.alter_column(u'yabi_toolgrouping', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ParameterSwitchUse.last_modified_by'
        db.alter_column(u'yabi_parameterswitchuse', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ParameterSwitchUse.created_by'
        db.alter_column(u'yabi_parameterswitchuse', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Credential.created_by'
        db.alter_column(u'yabi_credential', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Credential.last_modified_by'
        db.alter_column(u'yabi_credential', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolOutputExtension.last_modified_by'
        db.alter_column(u'yabi_tooloutputextension', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolOutputExtension.created_by'
        db.alter_column(u'yabi_tooloutputextension', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'FileExtension.last_modified_by'
        db.alter_column(u'yabi_fileextension', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'FileExtension.created_by'
        db.alter_column(u'yabi_fileextension', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolSet.last_modified_by'
        db.alter_column(u'yabi_toolset', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ToolSet.created_by'
        db.alter_column(u'yabi_toolset', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
