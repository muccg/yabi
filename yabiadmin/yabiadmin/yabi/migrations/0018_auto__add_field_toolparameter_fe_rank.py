...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ToolParameter.fe_rank'
        db.add_column(u'yabi_toolparameter', 'fe_rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ToolParameter.fe_rank'
        db.delete_column(u'yabi_toolparameter', 'fe_rank')
