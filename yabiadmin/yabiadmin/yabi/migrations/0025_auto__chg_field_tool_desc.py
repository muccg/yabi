...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tool.desc'
        db.alter_column(u'yabi_tool', 'desc_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['yabi.ToolDesc']))

    def backwards(self, orm):

        # Changing field 'Tool.desc'
        db.alter_column(u'yabi_tool', 'desc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.ToolDesc'], null=True))
