...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HostKey.data'
        db.alter_column('yabi_hostkey', 'data', self.gf('django.db.models.fields.TextField')(max_length=16384))


    def backwards(self, orm):
        
        # Changing field 'HostKey.data'
        db.alter_column('yabi_hostkey', 'data', self.gf('django.db.models.fields.CharField')(max_length=16384))
