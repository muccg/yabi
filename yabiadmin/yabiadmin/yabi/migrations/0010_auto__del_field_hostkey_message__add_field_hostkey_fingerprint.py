...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HostKey.message'
        db.delete_column('yabi_hostkey', 'message')

        # Adding field 'HostKey.fingerprint'
        db.add_column('yabi_hostkey', 'fingerprint', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'HostKey.message'
        raise RuntimeError("Cannot reverse this migration. 'HostKey.message' and its values cannot be restored.")

        # Deleting field 'HostKey.fingerprint'
        db.delete_column('yabi_hostkey', 'fingerprint')
