...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Credential.encrypt_on_login'
        db.delete_column('yabi_credential', 'encrypt_on_login')


    def backwards(self, orm):
        
        # Adding field 'Credential.encrypted'
        db.add_column('yabi_credential', 'encrypted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Credential.encrypt_on_login'
        db.add_column('yabi_credential', 'encrypt_on_login', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
