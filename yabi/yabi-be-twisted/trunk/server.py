...
class ServerContextFactory:
    def getContext(self):
        ...
        ctx.use_certificate_file(os.path.join(config.config['backend']['certificates'],'servercert.pem'))
        ctx.use_privatekey_file(os.path.join(config.config['backend']['certificates'],'serverkey.pem'))
        return ctx
