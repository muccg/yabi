...
def ConstructRSL(
    ...
    queue = "testing",
    jobType = "single"):
    return RSL(address=address, command=command, directory=directory, stdout=stdout, stderr=stderr, maxWallTime=maxWallTime, maxMemory=maxMemory, cpus=cpus, queue=queue, jobType=jobType)
