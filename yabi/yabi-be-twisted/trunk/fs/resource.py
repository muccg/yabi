...
class FileMkdirResource(resource.PostableResource):
    ...
    def http_POST(self, request):
        ...
        def MkdirCommand(res):
            ...
            mkdir=bend.http_MKDIR(request,path=[username]+pathremainder)
            ...
            def _mkdir_done(res):
                ...
                if res.code!=200:
                    ...
                    client_channel.callback(http.Response( responsecode.OK, {'content-type': http_headers.MimeType('text', 'plain')}, "OK!: %s\n"%str(res.stream.read())) )
