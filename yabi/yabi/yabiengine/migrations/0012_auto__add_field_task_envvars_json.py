...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.envvars_json'
        db.add_column(six.u('yabiengine_task'), 'envvars_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.envvars_json'
        db.delete_column(six.u('yabiengine_task'), 'envvars_json')
