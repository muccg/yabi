...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Task.exec_backend'
        db.delete_column('yabiengine_task', 'exec_backend')

        # Deleting field 'Task.fs_backend'
        db.delete_column('yabiengine_task', 'fs_backend')


    def backwards(self, orm):
        
        # Adding field 'Task.exec_backend'
        db.add_column('yabiengine_task', 'exec_backend', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Task.fs_backend'
        db.add_column('yabiengine_task', 'fs_backend', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)
