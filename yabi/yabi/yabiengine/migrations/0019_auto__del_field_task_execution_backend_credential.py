...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'yabiengine_task', 'execution_backend_credential_id')


    def backwards(self, orm):
        # Adding field 'Task.execution_backend_credential'
        db.add_column(u'yabiengine_task', 'execution_backend_credential',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.BackendCredential'], null=True),
                      keep_default=False)
