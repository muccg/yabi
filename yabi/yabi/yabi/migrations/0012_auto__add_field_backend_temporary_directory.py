...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Backend.temporary_directory'
        db.add_column(six.u('yabi_backend'), 'temporary_directory',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Backend.temporary_directory'
        db.delete_column(six.u('yabi_backend'), 'temporary_directory')
