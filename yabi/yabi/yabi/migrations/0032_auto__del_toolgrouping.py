...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'yabi_toolgrouping')


    def backwards(self, orm):
        # Adding model 'ToolGrouping'
        db.create_table(u'yabi_toolgrouping', (
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='toolgrouping_modifiers', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('tool_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.ToolGroup'])),
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.ToolDesc'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='toolgrouping_creators', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('tool_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.ToolSet'])),
        ))
        db.send_create_signal(u'yabi', ['ToolGrouping'])
    ...
    models = {
        ...
        u'yabi.newtoolgrouping': {
            'Meta': {'object_name': 'NewToolGrouping'},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newtoolgrouping_creators'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newtoolgrouping_modifiers'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'last_modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
