...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Backend.max_connections'
        db.delete_column(u'yabi_backend', 'max_connections')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Backend.max_connections'
        db.add_column(u'yabi_backend', 'max_connections',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
