...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewToolGrouping'
        db.create_table(u'yabi_newtoolgrouping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='newtoolgrouping_modifiers', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('last_modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='newtoolgrouping_creators', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'yabi', ['NewToolGrouping'])


    def backwards(self, orm):
        # Deleting model 'NewToolGrouping'
        db.delete_table(u'yabi_newtoolgrouping')
