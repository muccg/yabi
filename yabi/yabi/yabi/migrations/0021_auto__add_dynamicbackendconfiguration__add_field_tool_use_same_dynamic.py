...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DynamicBackendConfiguration'
        db.create_table(u'yabi_dynamicbackendconfiguration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dynamicbackendconfiguration_modifiers', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('last_modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dynamicbackendconfiguration_creators', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('configuration', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'yabi', ['DynamicBackendConfiguration'])

        # Adding field 'Tool.use_same_dynamic_backend'
        db.add_column(u'yabi_tool', 'use_same_dynamic_backend',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Backend.dynamic_backend'
        db.add_column(u'yabi_backend', 'dynamic_backend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Backend.dynamic_backend_configuration'
        db.add_column(u'yabi_backend', 'dynamic_backend_configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabi.DynamicBackendConfiguration'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DynamicBackendConfiguration'
        db.delete_table(u'yabi_dynamicbackendconfiguration')

        # Deleting field 'Tool.use_same_dynamic_backend'
        db.delete_column(u'yabi_tool', 'use_same_dynamic_backend')

        # Deleting field 'Backend.dynamic_backend'
        db.delete_column(u'yabi_backend', 'dynamic_backend')

        # Deleting field 'Backend.dynamic_backend_configuration'
        db.delete_column(u'yabi_backend', 'dynamic_backend_configuration_id')
