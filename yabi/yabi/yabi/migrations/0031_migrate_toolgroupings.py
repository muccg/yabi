...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for old_tg in orm.ToolGrouping.objects.all():
            for tool in old_tg.tool.tool_set.all():
                orm.NewToolGrouping.objects.create(tool=tool, tool_set=old_tg.tool_set, tool_group=old_tg.tool_group)
